...
const NotFound = () => {
    return (
        <div>
            ...
            <br></br>
            <h3 className='text-center text-3xl md:tex-4x1 lg:text-5xl font-semibold text-red-600'>SE O ERRO CONTINUAR ENTRE EM CONTATO EM NOSSO EMAIL: food@food.com</h3>
            <br></br>
